...
To install convexgating, run this command in your terminal:

.. code-block:: console

    $ pip install convexgating

This is the preferred method to install convexgating, as it will always install the most recent stable release.
