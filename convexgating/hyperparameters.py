...
show_HEAT = False  # True or False - show heat plots
save_HEAT = False  # True or False - save heat plots
show_SCATTER = False  # True or False - show scatter plots
save_SCATTER = False  # True or False - save scatter plots
show_metrics_df = False  # True or False - show metrics overview dataframe
save_metrics_df = False  # True or False - save metrics overview dataframe
save_metrics_plot = False  # True or False - show metrics overview plot
show_metrics_plot = False  # True or False - save metrics overview plot
